...
<head>
 ...
 var codesite_token = "S354ypG-M-ge5GO49ihFJQg4oyg:1359741902990";
 
 
 var CS_env = {"projectHomeUrl":"/p/brainbugz","token":"S354ypG-M-ge5GO49ihFJQg4oyg:1359741902990","projectName":"brainbugz","assetVersionPath":"http://www.gstatic.com/codesite/ph/6441139730022036690","domainName":null,"assetHostPath":"http://www.gstatic.com/codesite/ph","profileUrl":"/u/116163957316704900813/","relativeBaseUrl":"","loggedInUserEmail":"spookyhouseAdmin@gmail.com"};
 var _gaq = _gaq || [];
 _gaq.push(
...
<div class="headbg">
 ...
 ><u>Profile</u></a>
 | <a href="https://www.google.com/accounts/Logout?continue=http%3A%2F%2Fcode.google.com%2Fp%2Fbrainbugz%2Fsource%2Fbrowse%2Ftrunk%2Fsource%2FbbCombineDesiresNode.h" 
...
<table id="nav_and_rev" class="list"
 ...
 <span id="crumb_links" class="ifClosed"><a href="/p/brainbugz/source/browse/trunk/">trunk</a><span class="sp">/&nbsp;</span><a href="/p/brainbugz/source/browse/trunk/source/">source</a><span class="sp">/&nbsp;</span>bbCombineDesiresNode.h</span>
 ...
 <a href="/p/brainbugz/source/browse/trunk/source/bbCombineDesiresNode.h?edit=1"
...
><td class="source">#ifndef _bbCombineDesiresNode<br></td></tr
><tr
id=sl_svn79_2

><td class="source">#define _bbCombineDesiresNode<br></td></tr
><tr
id=sl_svn79_3
...
><td class="source">#include &lt;maya/MTypeId.h&gt; <br></td></tr
><tr
id=sl_svn79_9
...
><td class="source">#include &lt;maya/MDoubleArray.h&gt;<br></td></tr
><tr
id=sl_svn79_12
...
><td class="source">#define className bbCombineDesires<br></td></tr
><tr
id=sl_svn79_21
...
><td class="source">class bbCombineDesires : public MPxNode<br></td></tr
><tr
id=sl_svn79_24
...
><td class="source">						bbCombineDesires();<br></td></tr
><tr
id=sl_svn79_27

><td class="source">	virtual				~bbCombineDesires(); <br></td></tr
><tr
id=sl_svn79_28
...
><td class="source">	virtual MStatus		compute( const MPlug&amp; plug, MDataBlock&amp; data );<br></td></tr
><tr
id=sl_svn79_30
...
><td class="source">	static  MObject		inputForce;		// input attributes<br></td></tr
><tr
id=sl_svn79_37
...
><td class="source">	static  MObject		weight;<br></td></tr
><tr
id=sl_svn79_39

><td class="source">	static  MObject		priority;<br></td></tr
><tr
id=sl_svn79_40

><td class="source">	static  MObject		ditheringFactor;<br></td></tr
><tr
id=sl_svn79_41

><td class="source">	static  MObject		numForces;<br></td></tr
><tr
id=sl_svn79_42
...
><td class="source">	static  MObject		outputForce;		// output attribute<br></td></tr
><tr
id=sl_svn79_44

><td class="source">	static  MObject	    combineMode;<br></td></tr
><tr
id=sl_svn79_45
...
><td class="source">	static  MObject		selectedForce;<br></td></tr
><tr
id=sl_svn79_47
...
><td class="source">	void cdLinear(MArrayDataHandle &amp;inputForceAD,int numForces,MVectorArray &amp;outForces);<br></td></tr
><tr
id=sl_svn79_53

><td class="source">	void cdWeights(MArrayDataHandle &amp;inputForceAD,int numForces,MDataBlock&amp; data, MVectorArray &amp;outForces);<br></td></tr
><tr
id=sl_svn79_54

><td class="source">	void cdPriorities(MArrayDataHandle &amp;inputForceAD,int numForces, MDataBlock&amp; data, MVectorArray &amp;outForces);<br></td></tr
><tr
id=sl_svn79_55

><td class="source">	void cdSelect(MArrayDataHandle &amp;inputForceAD, MDataBlock&amp; data, MVectorArray &amp;outForces);<br></td></tr
><tr
id=sl_svn79_56
...
><td class="source">	MDoubleArray getWeights(MDataBlock&amp; data, int numForces);<br></td></tr
><tr
id=sl_svn79_59

><td class="source">	MIntArray getPriorities(MDataBlock&amp; data, int numForces);<br></td></tr
><tr
id=sl_svn79_60
...
><td class="source">	short	combineModeValue( MDataBlock&amp; block );<br></td></tr
><tr
id=sl_svn79_65

><td class="source">	short	selectedForceValue( MDataBlock&amp; block );<br></td></tr
><tr
id=sl_svn79_66
...
><td class="source">getShortAttrInline( combineMode);<br></td></tr
><tr
id=sl_svn79_80

><td class="source">getShortAttrInline( selectedForce);<br></td></tr
><tr
id=sl_svn79_81
...
<script type="text/javascript">
 ...
 by carsten.kolve
 on Nov 5, 2006
 &nbsp; <a href="/p/brainbugz/source/diff?spec=svn79&r=2&amp;format=side&amp;path=/trunk/source/bbCombineDesiresNode.h&amp;old_path=/trunk/source/bbCombineDesiresNode.h&amp;old=">Diff</a>
 </div>
 ...
 var selected_path = '/trunk/source/bbCombineDesiresNode.h';
 ...
 <a href="/p/brainbugz/source/list?path=/trunk/source/bbCombineDesiresNode.h&start=2">All revisions of this file</a>
 </div>
 </div>
 <div class="round1"></div>
 <div class="round2"></div>
 ...
 <div><a href="//brainbugz.googlecode.com/svn/trunk/source/bbCombineDesiresNode.h">View raw file</a></div>
 </div>
...
<script type="text/javascript">
 ...
 var paths = {'svn79': '/trunk/source/bbCombineDesiresNode.h'}
 codereviews = CR_controller.setup(
 {"projectHomeUrl":"/p/brainbugz","token":"S354ypG-M-ge5GO49ihFJQg4oyg:1359741902990","projectName":"brainbugz","assetVersionPath":"http://www.gstatic.com/codesite/ph/6441139730022036690","domainName":null,"assetHostPath":"http://www.gstatic.com/codesite/ph","profileUrl":"/u/116163957316704900813/","relativeBaseUrl":"","loggedInUserEmail":"spookyhouseAdmin@gmail.com"}, '', 'svn79', paths,
