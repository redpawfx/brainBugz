...
<head>
 ...
 var codesite_token = "oX42Zn4ZUU2aMmemG_SH2QNFaKo:1359741864973";
 
 
 var CS_env = {"assetHostPath":"http://www.gstatic.com/codesite/ph","loggedInUserEmail":"spookyhouseAdmin@gmail.com","profileUrl":"/u/116163957316704900813/","assetVersionPath":"http://www.gstatic.com/codesite/ph/6441139730022036690","projectHomeUrl":"/p/brainbugz","relativeBaseUrl":"","token":"oX42Zn4ZUU2aMmemG_SH2QNFaKo:1359741864973","domainName":null,"projectName":"brainbugz"};
 var _gaq = _gaq || [];
 _gaq.push(
...
<div class="headbg">
 ...
 ><u>Profile</u></a>
 | <a href="https://www.google.com/accounts/Logout?continue=http%3A%2F%2Fcode.google.com%2Fp%2Fbrainbugz%2Fsource%2Fbrowse%2Ftrunk%2Fsource%2FMTools.h" 
...
<table id="nav_and_rev" class="list"
 ...
 <span id="crumb_links" class="ifClosed"><a href="/p/brainbugz/source/browse/trunk/">trunk</a><span class="sp">/&nbsp;</span><a href="/p/brainbugz/source/browse/trunk/source/">source</a><span class="sp">/&nbsp;</span>MTools.h</span>
 ...
 <a href="/p/brainbugz/source/browse/trunk/source/MTools.h?edit=1"
...
><td class="source">#define MAX_DOUBLE 1.7E+308<br></td></tr
><tr
id=sl_svn79_5

><td class="source">#define MAX_INT		99999<br></td></tr
><tr
id=sl_svn79_6
...
><td class="source">void shellSort(MDoubleArray &amp;a)<br></td></tr
><tr
id=sl_svn79_9

><td class="source">// Sorts an array a[1..n] into ascending numerical order by Shell&#39;s method (diminishing increment<br></td></tr
><tr
id=sl_svn79_10

><td class="source">// sort). n is input; a is replaced on output by its sorted rearrangement.<br></td></tr
><tr
id=sl_svn79_11
...
><td class="source">	int n = a.length();<br></td></tr
><tr
id=sl_svn79_13
...
><td class="source">	double v;<br></td></tr
><tr
id=sl_svn79_16
...
><td class="source">	int inc = 1; <br></td></tr
><tr
id=sl_svn79_18
...
><td class="source">	// Determine the starting increment.<br></td></tr
><tr
id=sl_svn79_20
...
><td class="source">		inc *= 3;<br></td></tr
><tr
id=sl_svn79_24

><td class="source">		inc++;<br></td></tr
><tr
id=sl_svn79_25
...
><td class="source">	while (inc &lt;= n);<br></td></tr
><tr
id=sl_svn79_27
...
><td class="source">		// Loop over the partial sorts.<br></td></tr
><tr
id=sl_svn79_31
...
><td class="source">		for (i=inc+1;i&lt;=n;i++) <br></td></tr
><tr
id=sl_svn79_33
...
><td class="source">			// Outer loop of straight insertion.<br></td></tr
><tr
id=sl_svn79_35

><td class="source">			v=a[i];<br></td></tr
><tr
id=sl_svn79_36
...
><td class="source">			while (a[j-inc] &gt; v) <br></td></tr
><tr
id=sl_svn79_39
...
><td class="source">				// Inner loop of straight insertion.<br></td></tr
><tr
id=sl_svn79_41

><td class="source">				a[j]=a[j-inc];<br></td></tr
><tr
id=sl_svn79_42

><td class="source">				j -= inc;<br></td></tr
><tr
id=sl_svn79_43

><td class="source">				if (j &lt;= inc) break;<br></td></tr
><tr
id=sl_svn79_44
...
><td class="source">			a[j]=v;<br></td></tr
><tr
id=sl_svn79_47
...
><td class="source">	while (inc &gt; 1);<br></td></tr
><tr
id=sl_svn79_50
...
><td class="source">// median<br></td></tr
><tr
id=sl_svn79_53
...
><td class="source">double median(MDoubleArray data)<br></td></tr
><tr
id=sl_svn79_55
...
><td class="source">	int n = data.length();<br></td></tr
><tr
id=sl_svn79_57

><td class="source">	double medianV;<br></td></tr
><tr
id=sl_svn79_58
...
><td class="source">	if ( fmod(n,2.0)==0.0)<br></td></tr
><tr
id=sl_svn79_60
...
><td class="source">		// n even<br></td></tr
><tr
id=sl_svn79_62

><td class="source">		medianV = 0.5 * (data[(n/2)]+data[(n/2)+1]);<br></td></tr
><tr
id=sl_svn79_63
...
><td class="source">		// n odd<br></td></tr
><tr
id=sl_svn79_67

><td class="source">		medianV = data[(n+1)/2];<br></td></tr
><tr
id=sl_svn79_68
...
><td class="source">	return medianV;<br></td></tr
><tr
id=sl_svn79_71
...
<script type="text/javascript">
 ...
 by carsten.kolve
 on Nov 5, 2006
 &nbsp; <a href="/p/brainbugz/source/diff?spec=svn79&r=2&amp;format=side&amp;path=/trunk/source/MTools.h&amp;old_path=/trunk/source/MTools.h&amp;old=">Diff</a>
 </div>
 ...
 var selected_path = '/trunk/source/MTools.h';
 ...
 <a href="/p/brainbugz/source/list?path=/trunk/source/MTools.h&start=2">All revisions of this file</a>
 </div>
 </div>
 <div class="round1"></div>
 <div class="round2"></div>
 ...
 <div><a href="//brainbugz.googlecode.com/svn/trunk/source/MTools.h">View raw file</a></div>
 </div>
...
<script type="text/javascript">
 ...
 var paths = {'svn79': '/trunk/source/MTools.h'}
 codereviews = CR_controller.setup(
 {"assetHostPath":"http://www.gstatic.com/codesite/ph","loggedInUserEmail":"spookyhouseAdmin@gmail.com","profileUrl":"/u/116163957316704900813/","assetVersionPath":"http://www.gstatic.com/codesite/ph/6441139730022036690","projectHomeUrl":"/p/brainbugz","relativeBaseUrl":"","token":"oX42Zn4ZUU2aMmemG_SH2QNFaKo:1359741864973","domainName":null,"projectName":"brainbugz"}, '', 'svn79', paths,
